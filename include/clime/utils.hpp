...
*/
/*******************************************************************************
 * libclime: Command line parser utilities
 *	@file		clime/utils.hpp
 *	@brief		Command line parser helpers
 ******************************************************************************/
#pragma once
#ifndef CLIME_UTILS_HPP
#define CLIME_UTILS_HPP
...
public:
    ...
    VersionPrinter(Solace::StringView canonicalAppName, Solace::Version const& version)
...
private:
    Solace::StringView const    _canonicalAppName;
    Solace::Version const&      _version;
};
...
public:
    ...
    void operator() (std::ostream& output, Solace::StringView name, Parser::Command const& command);
